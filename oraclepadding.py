...
def decode(secret: bytearray, iv: bytearray)->int:
    cmd="java -jar ./target/aesdemo-1.0-SNAPSHOT.jar decrypt {secret} keykeyke {iv}"\
...
def burp_iv_single_core(secret_block: bytearray, iv: bytearray, pos: int)->int:
...
def burp_iv_mulit_core(secret_block: bytearray, iv: bytearray, pos: int)->int:
